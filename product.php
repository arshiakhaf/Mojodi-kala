...
<body class="portal-page">
    ...
    <main class="detail-main">
        <div class="portal-container">
            <div class="detail-topbar"><a class="detail-back" href="index.php#results"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" aria-hidden="true"><path d="M19 12H5M11 6l-6 6 6 6" stroke-linecap="round" stroke-linejoin="round"/></svg>بازگشت به نتایج</a><span class="portal-status">جزئیات کالا</span></div>
            <?php if (!$product): ?>
                <section class="portal-card" style="text-align:center; padding:70px 25px;"><h1 class="portal-title">کالا پیدا نشد</h1><p class="portal-lead">شناسه کالا معتبر نیست یا این کالا از فهرست سامانه حذف شده است.</p><a class="btn btn-primary" href="index.php#search" style="margin-top:20px;">بازگشت به جست‌وجو</a></section>
            <?php else: ?>
                <div class="detail-layout">
                    <div>
                        <section class="detail-hero">
                            <div class="detail-image"><img src="<?= product_e($product['image']) ?>" alt="تصویر <?= product_e($product['title']) ?>"></div>
                        ...
                        <section class="detail-offers">
                            <h2>پیشنهادهای فروشندگان</h2><p class="detail-offers-lead">قیمت‌ها و شرایط ثبت‌شده برای این کالا را مقایسه کنید.</p>
                            ...
                            <?php endforeach; ?>
                            <div class="detail-notice"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="m12 4 9 16H3L12 4Z"/><path d="M12 9v5M12 17h.01" stroke-linecap="round"/></svg><span>قبل از پرداخت، اصالت کالا، قیمت، موجودی و شرایط معامله را مستقیماً با فروشنده بررسی کنید.</span></div>
                        </section>
                    </div>
