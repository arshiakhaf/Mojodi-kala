 ...
 *
 * SQLite برای نسخه قابل حمل استفاده می‌شود. اگر هاست SQLite نداشته باشد،
 * سایت عمومی همچنان با داده‌های اولیه‌ی data.php بالا می‌آید و پنل فروشنده
...
function app_login(string $phone, string $password): bool
{
    ...
    // حساب ورود اولیه، زمانی که PDO SQLite روی هاست فعال نیست.
