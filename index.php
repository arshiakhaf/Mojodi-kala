    ...
    <header class="site-header">
        <div class="container header-shell">
            ...
            <div class="header-actions">
                <a class="header-login" href="login.php">ورود فروشندگان</a>
                <a class="btn btn-primary" href="login.php?mode=register">ثبت فروشگاه</a>
                ...
                <?php if (count($filteredProducts) > 0): ?>
                    <div class="results-grid">
                        <?php foreach ($filteredProducts as $product):
                            ...
                            $minPriceLabel = $prices ? format_price($minPrice) : 'در انتظار ثبت قیمت';
                            ...
                            <article class="product-card">
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-bottom">
                                        <div><span class="price-label">شروع قیمت از</span><strong class="price-value"><?= e($minPriceLabel) ?></strong></div>
                                        <div class="product-buttons"><a class="product-page-link" href="product.php?id=<?= e($product['id']) ?>">صفحه کالا</a><button class="product-detail-btn js-product-detail" type="button" data-product-id="<?= e($product['id']) ?>">مشاهده قیمت‌ها</button></div>
                                    </div>
                                </div>
                            </article>
                        <?php endforeach; ?>
        ...
        <section class="seller-cta" id="seller-cta">
            <div class="container">
                <div class="seller-card">
                    ...
                    <a class="btn btn-white" href="login.php?mode=register">ثبت موجودی فروشگاه <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
                </div>
            </div>
        </section>
    </main>
